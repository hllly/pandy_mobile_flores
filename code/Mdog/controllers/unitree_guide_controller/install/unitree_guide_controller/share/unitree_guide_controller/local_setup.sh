...
: ${AMENT_CURRENT_PREFIX:="/home/malab/XJL/project/quadruped_ros2_control/src/quadruped_ros2_control/controllers/unitree_guide_controller/install/unitree_guide_controller"}
