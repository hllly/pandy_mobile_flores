...
In theory, it also can communicate with real robot, but it is not tested yet. You can use go2 simulation in [unitree_mujoco](https://github.com/legupj/unitree_mujoco). In this simulation, I add foot force sensor support.
